...
print(not name != "John" or not age != 17)  # Напишите логическое выражение со значением "человека зовут John или ему 17" с использованием оператора not
...
print(not name == "John" and age > 20 and not name[0] == "E")